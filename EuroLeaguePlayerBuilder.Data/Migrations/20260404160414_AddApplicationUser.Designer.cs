...
namespace EuroLeaguePlayerBuilder.Data.Migrations
{
    ...
    [Migration("20260404160414_AddApplicationUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EuroLeaguePlayerBuilder.Data.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("EuroLeaguePlayerBuilder.Data.Models.Arena", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Athens",
                            Country = "Greece",
                            ImagePath = "/images/arenas/oaka.jpg",
                            Name = "OAKA"
                        },
                        new
                        {
                            ...
                            City = "Piraeus",
                            Country = "Greece",
                            ImagePath = "/images/arenas/peace_and_friendship_stadium.jpg",
                        ...
                        new
                        {
                            ...
                            City = "Madrid",
                            Country = "Spain",
                            ImagePath = "/images/arenas/wizink_center.jpg",
                            Name = "WiZink Center"
                        },
                        new
                        {
                            ...
                            City = "Barcelona",
                            Country = "Spain",
                            ImagePath = "/images/arenas/palau_blaugrana.jpg",
                        ...
                        new
                        {
                            ...
                            City = "Belgrade",
                            Country = "Serbia",
                            ImagePath = "/images/arenas/belgrade_arena.jpg",
                            Name = "Belgrade Arena"
                        });
                });

            modelBuilder.Entity("EuroLeaguePlayerBuilder.Data.Models.Coach", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EuroLeaguePlayerBuilder.Data.Models.Game", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EuroLeaguePlayerBuilder.Data.Models.Player", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EuroLeaguePlayerBuilder.Data.Models.Team", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CoachId = 1,
                            Country = "Greece",
                            LogoPath = "/images/teams/panathinaikos.svg.png",
                            Name = "Panathinaikos"
                        },
                        new
                        {
                            ...
                            CoachId = 2,
                            Country = "Greece",
                            LogoPath = "/images/teams/olympiacos.svg.png",
                            Name = "Olympiacos"
                        },
                        new
                        {
                            ...
                            CoachId = 3,
                            Country = "Spain",
                            LogoPath = "/images/teams/real_madrid.svg.png",
                            Name = "Real Madrid"
                        },
                        new
                        {
                            ...
                            CoachId = 4,
                            Country = "Spain",
                            LogoPath = "/images/teams/barcelona.svg.png",
                            Name = "Barcelona"
                        },
                        new
                        {
                            ...
                            CoachId = 5,
                            Country = "Serbia",
                            LogoPath = "/images/teams/crvena_zvezda.svg.png",
                            Name = "Crvena Zvezda"
                        },
                        new
                        {
                            ...
                            CoachId = 6,
                            Country = "Serbia",
                            LogoPath = "/images/teams/partizan.svg.png",
                            Name = "Partizan"
                        });
                });
            ...
            modelBuilder.Entity("EuroLeaguePlayerBuilder.Data.Models.Arena", b =>
                {
                    b.HasOne("EuroLeaguePlayerBuilder.Data.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("EuroLeaguePlayerBuilder.Data.Models.Game", b =>
                {
                    b.HasOne("EuroLeaguePlayerBuilder.Data.Models.Arena", "Arena")
                        .WithMany()
                        .HasForeignKey("ArenaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EuroLeaguePlayerBuilder.Data.Models.Team", "TeamOne")
                        .WithMany()
                        .HasForeignKey("TeamOneId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EuroLeaguePlayerBuilder.Data.Models.Team", "TeamTwo")
                        .WithMany()
            ...
            modelBuilder.Entity("EuroLeaguePlayerBuilder.Data.Models.Player", b =>
                {
                    b.HasOne("EuroLeaguePlayerBuilder.Data.Models.Team", "Team")
                        .WithMany("Players")
            ...
            modelBuilder.Entity("EuroLeaguePlayerBuilder.Data.Models.Team", b =>
                {
                    ...
                    b.HasOne("EuroLeaguePlayerBuilder.Data.Models.Coach", "Coach")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EuroLeaguePlayerBuilder.Data.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
